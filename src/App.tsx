    ...
    <div className="min-h-screen bg-[#030305] text-slate-300 flex flex-col font-sans select-none antialiased relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none select-none overflow-hidden bg-[#030305]">
        <img 
          ...
          className="w-full h-full object-cover opacity-[0.55] scale-105 filter brightness-110 contrast-125 animate-[pulse_15s_infinite]"
          onError={(e) => {
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#030305] via-[#030305]/60 to-[#030305]/20" />
        <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(circle at center, transparent 40%, #030305 100%)' }} />
              ...
              <div className="relative overflow-hidden rounded-3xl border border-blue-500/20 shadow-[0_20px_50px_rgba(0,0,0,0.6)] bg-[#0c1020]/45 group cyber-bracket relative">
                <div className="absolute inset-0 z-0 bg-[#030305]">
                  <img 
                    ...
                    className="w-full h-full object-cover object-center opacity-80 group-hover:scale-[1.03] transition-transform duration-[4s] select-none pointer-events-none filter brightness-110 contrast-125 mix-blend-screen"
                    onError={(e) => {
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#030305] via-[#030305]/20 to-blue-900/10"></div>
                  <div className="absolute inset-0 bg-gradient-to-b from-[#030305]/10 via-transparent to-[#030305]/90"></div>
                </div>
